...
@pytest.mark.parametrize(
    'cache_enabled,terms_agreed,request_url,response_count,queries_count', [
        ...
        (False, False, reverse('admin:logout'), 1, 0),  # User can logout
        (False, False, reverse(
            'admin:app_list', args=('letsagree', )), 1, 0),  # User can visit app
...
def test_middleware(queries, settings, django_assert_num_queries, queries_count,
                    request_url, response_count, cache_enabled, terms_agreed):
    '''
